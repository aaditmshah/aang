...
export class Pair<out A, out B> {
	...
	public mapFst<A, B, C>(this: Pair<A, C>, morphism: (fst: A) => B): Pair<B, C> {
		return new Pair(morphism(this.fst), this.snd);
	}

	public mapSnd<A, B, C>(this: Pair<A, B>, morphism: (snd: B) => C): Pair<A, C> {
	...
	public and<A, B, C, D>(this: Pair<A, B>, that: Pair<C, D>): Pair<Pair<A, C>, Pair<B, D>> {
	...
	public andThenFst<A, B, C extends Semigroup<C>>(this: Pair<A, C>, that: Pair<B, C>): Pair<B, C> {
		return new Pair(that.fst, this.snd.append(that.snd));
	}

	public andWhenFst<A, B, C extends Semigroup<C>>(this: Pair<A, C>, that: Pair<B, C>): Pair<A, C> {
	...
	public andThenSnd<A extends Semigroup<A>, B, C>(this: Pair<A, B>, that: Pair<A, C>): Pair<A, C> {
		return new Pair(this.fst.append(that.fst), that.snd);
	}

	public andWhenSnd<A extends Semigroup<A>, B, C>(this: Pair<A, B>, that: Pair<A, C>): Pair<A, B> {
	...
	public flattenFst<A, B extends Semigroup<B>>(this: Pair<Pair<A, B>, B>): Pair<A, B> {
		return this.fst.mapSnd((snd) => this.snd.append(snd));
	}

	public flattenSnd<A extends Semigroup<A>, B>(this: Pair<A, Pair<A, B>>): Pair<A, B> {
	...
	public flatMapFstUntil<A, B, C extends Semigroup<C>>(
		...
		while (result.isFail) result = result.value.flatMapFst(arrow).distributeFail();
		return result.value;
	}
	...
	public flatMapSndUntil<A extends Semigroup<A>, B, C>(
		...
		while (result.isFail) result = result.value.flatMapSnd(arrow).distributeOkay();
		return result.value;
	}

	public extendMapFst<A, B, C>(this: Pair<A, C>, arrow: (pair: Pair<A, C>) => B): Pair<B, C> {
		return new Pair(arrow(this), this.snd);
	}

	public extendMapSnd<A, B, C>(this: Pair<A, B>, arrow: (pair: Pair<A, B>) => C): Pair<A, C> {
	...
	public andResult<A, B, E>(this: Pair<Result<A, E>, Result<B, E>>): Result<Pair<A, B>, E> {
		return this.fst.and(this.snd);
	}

	public andFstResult<A, B, E>(this: Pair<Result<A, E>, B>): Result<Pair<A, B>, E> {
		return this.fst.and(new Okay(this.snd));
	}

	public andSndResult<A, B, E>(this: Pair<A, Result<B, E>>): Result<Pair<A, B>, E> {
	...
	public orResult<A, E, F>(this: Pair<Result<A, E>, Result<A, F>>): Result<A, Pair<E, F>> {
		return this.fst.or(this.snd);
	}

	public orFstResult<A, E, F>(this: Pair<Result<A, E>, F>): Result<A, Pair<E, F>> {
		return this.fst.or(new Fail(this.snd));
	}

	public orSndResult<A, E, F>(this: Pair<E, Result<A, F>>): Result<A, Pair<E, F>> {
	...
	public andTask<A, B, E>(this: Pair<Task<A, E>, Task<B, E>>): Task<Pair<A, B>, E> {
		return this.fst.and(this.snd);
	}
	...
	public orTask<A, E, F>(this: Pair<Task<A, E>, Task<A, F>>): Task<A, Pair<E, F>> {
		return this.fst.or(this.snd);
	}
	...
	public distribute<A, B, C, D>(this: Pair<Pair<A, B>, Pair<C, D>>): Pair<Pair<A, C>, Pair<B, D>> {
		return new Pair(new Pair(this.fst.fst, this.snd.fst), new Pair(this.fst.snd, this.snd.snd));
	}

	public distributeFst<A, B, C>(this: Pair<Pair<A, B>, C>): Pair<Pair<A, C>, Pair<B, C>> {
		return new Pair(new Pair(this.fst.fst, this.snd), new Pair(this.fst.snd, this.snd));
	}

	public distributeSnd<A, B, C>(this: Pair<A, Pair<B, C>>): Pair<Pair<A, B>, Pair<A, C>> {
	...
	public associateLeft<A, B, C>(this: Pair<A, Pair<B, C>>): Pair<Pair<A, B>, C> {
	...
	public associateRight<A, B, C>(this: Pair<Pair<A, B>, C>): Pair<A, Pair<B, C>> {
	...
	public distributeOkay<A, B, C>(this: Pair<A, Result<B, C>>): Result<Pair<A, B>, Pair<A, C>> {
		return this.snd.map(
			(snd) => new Pair(this.fst, snd),
			(snd) => new Pair(this.fst, snd),
		);
	...
	public distributeFail<A, B, C>(this: Pair<Result<A, B>, C>): Result<Pair<A, C>, Pair<B, C>> {
		return this.fst.map(
			(fst) => new Pair(fst, this.snd),
			(fst) => new Pair(fst, this.snd),
		);
	...
	public scatterOkay<A, B, C>(this: Pair<A, Task<B, C>>): Task<Pair<A, B>, Pair<A, C>> {
		return this.snd.map(
			(snd) => new Pair(this.fst, snd),
			(snd) => new Pair(this.fst, snd),
		);
	...
	public scatterFail<A, B, C>(this: Pair<Task<A, B>, C>): Task<Pair<A, C>, Pair<B, C>> {
		return this.fst.map(
			(fst) => new Pair(fst, this.snd),
			(fst) => new Pair(fst, this.snd),
		);
